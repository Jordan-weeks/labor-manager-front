...
function createContext(options = {}) {
  ...
  function useContext19() {
    ...
    if (!context && strict) {
      ...
      (_a = Error.captureStackTrace) == null ? void 0 : _a.call(Error, error, useContext19);
      throw error;
    }
    return context;
  }
...
var EnvironmentContext = (0, import_react4.createContext)(defaultEnv);
...
function EnvironmentProvider(props) {
  ...
  const [node2, setNode] = (0, import_react4.useState)(null);
  ...
  return (0, import_jsx_runtime4.jsxs)(EnvironmentContext.Provider, { value: context, children: [
    children,
    !environmentProp && mounted && (0, import_jsx_runtime4.jsx)(
      "span",
      {
        id: "__chakra_env",
        hidden: true,
...
var ChakraProvider = (props) => {
  ...
  const _children = (0, import_jsx_runtime5.jsx)(EnvironmentProvider, { environment, children });
  return (0, import_jsx_runtime5.jsx)(ThemeProvider, { theme: theme2, cssVarsRoot, children: (0, import_jsx_runtime5.jsxs)(
    ColorModeProvider,
    {
      ...
      children: [
        resetCSS ? (0, import_jsx_runtime5.jsx)(CSSReset, {}) : (0, import_jsx_runtime5.jsx)(CSSPolyfill, {}),
...
function useCreateMotionContext(props) {
  const { initial, animate: animate4 } = getCurrentTreeVariants(props, (0, import_react15.useContext)(MotionContext));
  return (0, import_react15.useMemo)(() => ({ initial, animate: animate4 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate4)]);
}
...
var VisualElementHandler = class extends import_react18.default.Component {
  /**
...
function createMotionComponent({ preloadedFeatures, createVisualElement, projectionNodeConstructor, useRender, useVisualState: useVisualState2, Component: Component2 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser2) {
      ...
      const lazyStrictMode = (0, import_react20.useContext)(LazyContext).strict;
  ...
  const ForwardRefComponent = (0, import_react20.forwardRef)(MotionComponent);
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, projectionId, ref, { latestValues }, isStatic) => {
    ...
    return (0, import_react23.createElement)(Component2, {
      ...elementProps,
...
function useFocusGesture({ whileFocus, visualElement }) {
  ...
  const onFocus3 = (0, import_react26.useCallback)(() => {
...
function useHoverGesture({ onHoverStart, onHoverEnd, whileHover, visualElement }) {
  usePointerEvent(visualElement, "pointerenter", (0, import_react27.useMemo)(() => {
  ...
  usePointerEvent(visualElement, "pointerleave", (0, import_react27.useMemo)(() => {
...
function useTapGesture({ onTap, onTapStart, onTapCancel, whileTap, visualElement, ...props }) {
  ...
  const isPressing = (0, import_react29.useRef)(false);
  const cancelPointerEndListeners = (0, import_react29.useRef)(null);
  const eventOptions = {
  ...
  const startPress = (0, import_react29.useCallback)((event, info) => {
    var _a, _b;
    removePointerEndListener();
...
function usePresence() {
  const context = (0, import_react31.useContext)(PresenceContext);
  if (context === null)
    return [true, null];
  const { isPresent: isPresent2, onExitComplete, register } = context;
  const id3 = (0, import_react31.useId)();
  (0, import_react31.useEffect)(() => register(id3), []);
...
var animations = {
  animation: makeRenderlessComponent(({ visualElement, animate: animate4 }) => {
    ...
    if (isAnimationControls(animate4)) {
      (0, import_react32.useEffect)(() => animate4.subscribe(visualElement), [animate4]);
    }
  }),
...
function useDrag(props) {
  ...
  (0, import_react33.useEffect)(() => groupDragControls && groupDragControls.subscribe(dragControls), [dragControls, groupDragControls]);
  (0, import_react33.useEffect)(() => dragControls.addListeners(), [dragControls]);
}
...
function usePanGesture({ onPan, onPanStart, onPanEnd, onPanSessionStart, visualElement }) {
  ...
  const panSession = (0, import_react34.useRef)(null);
  const { transformPagePoint } = (0, import_react34.useContext)(MotionConfigContext);
  const handlers2 = {
  ...
  loadFeatures({ children, ...renderedProps }, isStrict, preloadedFeatures, projectionId, ProjectionNodeConstructor, initialLayoutGroupConfig) {
    ...
    for (let i = 0; i < numFeatures; i++) {
      ...
      if (isEnabled(renderedProps) && Component2) {
        features.push((0, import_react35.createElement)(Component2, {
          key: name,
          ...renderedProps,
          visualElement: this
        }));
...
function mixValues(target, follow, lead, progress4, shouldCrossfadeOpacity, isOnlyMember) {
  if (shouldCrossfadeOpacity) {
    ...
    target.opacityExit = mix(follow.opacity !== void 0 ? follow.opacity : 1, 0, easeCrossfadeOut(progress4));
  } else if (isOnlyMember) {
    target.opacity = mix(follow.opacity !== void 0 ? follow.opacity : 1, lead.opacity !== void 0 ? lead.opacity : 1, progress4);
  }
  ...
  return class ProjectionNode {
    ...
    removeTransform(box) {
      ...
      for (let i = 0; i < this.path.length; i++) {
        ...
        removeBoxTransforms(boxWithoutTransform, node2.latestValues, (_a = node2.snapshot) === null || _a === void 0 ? void 0 : _a.layoutBox, sourceBox);
      }
      if (hasTransform(this.latestValues)) {
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react38.useCallback)(() => sync.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  const size = (0, import_react39.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRenderLayoutGroup = (0, import_react41.useContext)(LayoutGroupContext).forceRender;
  ...
  const presentChildren = (0, import_react41.useRef)(childrenToRender);
  const allChildren = (0, import_react41.useRef)(/* @__PURE__ */ new Map()).current;
  const isInitialRender = (0, import_react41.useRef)(true);
  useIsomorphicLayoutEffect(() => {
  ...
  return React4.createElement(React4.Fragment, null, exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react41.cloneElement)(child)));
};
...
var Group = (0, import_react47.forwardRef)(ReorderGroup);
...
function useMotionValue(initial) {
  ...
  const { isStatic } = (0, import_react48.useContext)(MotionConfigContext);
  if (isStatic) {
    const [, setLatest] = (0, import_react48.useState)(initial);
    (0, import_react48.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
function ReorderItem({ children, style: style2 = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  const measuredLayout = (0, import_react49.useRef)(null);
  invariant(Boolean(context), "Reorder.Item must be a child of Reorder.Group");
  const { axis, registerItem, updateOrder } = context;
  (0, import_react49.useEffect)(() => {
    registerItem(value, measuredLayout.current);
  }, [context]);
  return React10.createElement(Component2, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style2, x: point.x, y: point.y, zIndex }, layout: layout2, onDrag: (event, gesturePoint) => {
...
var Item = (0, import_react49.forwardRef)(ReorderItem);
...
var mix2 = (min2, max2, progress4) => -progress4 * min2 + progress4 * max2 + min2;
...
var steps2 = (steps3, direction = "end") => (progress4) => {
  progress4 = direction === "end" ? Math.min(progress4, 0.999) : Math.max(progress4, 1e-3);
  const expanded = progress4 * steps3;
...
var Animation = class {
  constructor(output, keyframes3 = [0, 1], { easing, duration: initialDuration = defaults.duration, delay: delay2 = defaults.delay, endDelay = defaults.endDelay, repeat = defaults.repeat, offset: offset2, direction = "normal" } = {}) {
    this.startTime = null;
    this.rate = 1;
    this.t = 0;
    ...
    if (isEasingGenerator(easing)) {
      const custom = easing.createAnimation(keyframes3);
      easing = custom.easing;
      keyframes3 = custom.keyframes || keyframes3;
      initialDuration = custom.duration || initialDuration;
    }
    this.repeat = repeat;
    this.easing = isEasingList(easing) ? noopReturn : getEasingFunction(easing);
    this.updateDuration(initialDuration);
    const interpolate$1 = interpolate2(keyframes3, offset2, isEasingList(easing) ? easing.map(getEasingFunction) : noopReturn);
    this.tick = (timestamp) => {
      var _a;
      delay2 = delay2;
      let t = 0;
      ...
      const progress4 = t / this.duration;
...
function hydrateKeyframes(keyframes3, readInitialValue) {
  for (let i = 0; i < keyframes3.length; i++) {
    if (keyframes3[i] === null) {
      keyframes3[i] = i ? keyframes3[i - 1] : readInitialValue();
    }
  }
  return keyframes3;
}
var keyframesList = (keyframes3) => Array.isArray(keyframes3) ? keyframes3 : [keyframes3];
...
function getUnitConverter(keyframes3, definition) {
  var _a;
  let toUnit = (definition === null || definition === void 0 ? void 0 : definition.toDefaultUnit) || noopReturn;
  const finalKeyframe = keyframes3[keyframes3.length - 1];
...
function animateStyle2(element, key, keyframesDefinition, options = {}, AnimationPolyfill) {
  ...
  let animation;
  let { duration = defaults.duration, delay: delay2 = defaults.delay, endDelay = defaults.endDelay, repeat = defaults.repeat, easing = defaults.easing, persist = false, direction, offset: offset2, allowWebkitAcceleration = false } = options;
  ...
  return () => {
    ...
    let keyframes3 = hydrateKeyframes(keyframesList(keyframesDefinition), readInitialValue);
    const toUnit = getUnitConverter(keyframes3, definition);
    if (isEasingGenerator(easing)) {
      const custom = easing.createAnimation(keyframes3, key !== "opacity", readInitialValue, name, motionValue2);
      easing = custom.easing;
      keyframes3 = custom.keyframes || keyframes3;
    ...
    if (canAnimateNatively) {
      if (definition) {
        keyframes3 = keyframes3.map((value) => isNumber(value) ? definition.toDefaultUnit(value) : value);
      }
      if (keyframes3.length === 1 && (!supports2.partialKeyframes() || isRecording)) {
        keyframes3.unshift(readInitialValue());
      }
      const animationOptions = {
      ...
      keyframes3 = keyframes3.map((value) => typeof value === "string" ? parseFloat(value) : value);
      if (keyframes3.length === 1) {
        keyframes3.unshift(parseFloat(readInitialValue()));
      }
      animation = new AnimationPolyfill((latest) => {
        style.set(element, name, toUnit ? toUnit(latest) : latest);
      }, keyframes3, Object.assign(Object.assign({}, options), {
        duration,
        easing
      }));
    } else {
...
function createAnimate(AnimatePolyfill) {
  return function animate4(elements, keyframes3, options = {}) {
    elements = resolveElements(elements);
    const numElements = elements.length;
    invariant(Boolean(numElements), "No valid element provided.");
    invariant(Boolean(keyframes3), "No keyframes defined.");
    ...
    for (let i = 0; i < numElements; i++) {
      ...
      for (const key in keyframes3) {
        ...
        const animation = animateStyle2(element, key, keyframes3[key], valueOptions, AnimatePolyfill);
...
function createGeneratorEasing(createGenerator) {
  ...
  return (options = {}) => {
    ...
    return {
      createAnimation: (keyframes3, shouldGenerate = true, getOrigin2, name, motionValue2) => {
        let settings;
        let origin;
        let target;
        let velocity = 0;
        ...
        if (shouldGenerate) {
          toUnit = getUnitConverter(keyframes3, name ? transformDefinitions.get(getStyleName(name)) : void 0);
          const targetDefinition = keyframes3[numKeyframes - 1];
          target = getAsNumber(targetDefinition);
          if (numKeyframes > 1 && keyframes3[0] !== null) {
            origin = getAsNumber(keyframes3[0]);
          } else {
  ...
  const normalizeToastOptions = (options) => {
    ...
    return {
      ...
      position: getToastPlacement(
        (_a = options == null ? void 0 : options.position) != null ? _a : defaultOptions3 == null ? void 0 : defaultOptions3.position,
        dir
      )
    };
  };
...
var ToastProvider = (props) => {
  const state = (0, import_react62.useSyncExternalStore)(
...
var useSafeLayoutEffect2 = typeof window !== "undefined" ? import_react64.useLayoutEffect : import_react64.useEffect;
...
function useMergeRefs(...refs) {
  return (0, import_react65.useMemo)(() => mergeRefs(...refs), refs);
}

// node_modules/@chakra-ui/descendant/dist/chunk-D5UZ3RNN.mjs
var import_react66 = __toESM(require_react(), 1);
function useDescendants() {
  const descendants = (0, import_react66.useRef)(new DescendantsManager());
...
function useDescendant(options) {
  ...
  const [index2, setIndex] = (0, import_react66.useState)(-1);
...
function useControllableState(props) {
  ...
  const [uncontrolledState, setUncontrolledState] = (0, import_react67.useState)(defaultValue);
...
function useAccordion(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react68.useState)(-1);
...
function useAccordionItem(props) {
  ...
  const onClick = (0, import_react68.useCallback)(() => {
  ...
  const onFocus3 = (0, import_react68.useCallback)(() => {
    setFocusedIndex(index2);
  }, [setFocusedIndex, index2]);
  ...
  const getPanelProps = (0, import_react68.useCallback)(
...
var AccordionItem = forwardRef(
  function AccordionItem2(props, ref) {
    ...
    const ctx = (0, import_react69.useMemo)(() => context, [context]);
...
var variants = {
  exit: ({
    ...
    return {
      ...
      transition: (_a = transition2 == null ? void 0 : transition2.exit) != null ? _a : withDelay.exit(defaultTransitions2.exit, delay2)
    };
  },
  enter: ({
    animateOpacity,
    ...
    return {
      ...
      transition: (_a = transition2 == null ? void 0 : transition2.enter) != null ? _a : withDelay.enter(defaultTransitions2.enter, delay2)
    };
  }
};
var Collapse = (0, import_react70.forwardRef)(
  (props, ref) => {
    const {
      in: isOpen,
      unmountOnExit,
...
var variants2 = {
  enter: ({ transition: transition2, transitionEnd, delay: delay2 } = {}) => {
    ...
    return {
      opacity: 1,
      transition: (_a = transition2 == null ? void 0 : transition2.enter) != null ? _a : withDelay.enter(TRANSITION_DEFAULTS.enter, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.enter
    };
  },
  exit: ({ transition: transition2, transitionEnd, delay: delay2 } = {}) => {
    ...
    return {
      opacity: 0,
      transition: (_a = transition2 == null ? void 0 : transition2.exit) != null ? _a : withDelay.exit(TRANSITION_DEFAULTS.exit, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.exit
    };
  }
};
...
var Fade = (0, import_react71.forwardRef)(function Fade2(props, ref) {
  const {
    unmountOnExit,
    in: isOpen,
    className,
...
var ScaleFade = (0, import_react72.forwardRef)(
...
var SlideFade = (0, import_react73.forwardRef)(
...
var variants5 = {
  exit: ({ direction, transition: transition2, transitionEnd, delay: delay2 }) => {
    ...
    return {
      ...exitStyles,
      transition: (_a = transition2 == null ? void 0 : transition2.exit) != null ? _a : withDelay.exit(defaultTransition.exit, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.exit
    };
  },
  enter: ({ direction, transitionEnd, transition: transition2, delay: delay2 }) => {
    ...
    return {
      ...enterStyles,
      transition: (_a = transition2 == null ? void 0 : transition2.enter) != null ? _a : withDelay.enter(defaultTransition.enter, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.enter
    };
  }
};
var Slide = (0, import_react74.forwardRef)(function Slide2(props, ref) {
  const {
    direction = "right",
    style: style2,
    unmountOnExit,
...
var Accordion = forwardRef(function Accordion2({ children, reduceMotion, ...props }, ref) {
  ...
  const ctx = (0, import_react75.useMemo)(
...
function useImage(props) {
  ...
  const [status, setStatus] = (0, import_react76.useState)("pending");
  (0, import_react76.useEffect)(() => {
    setStatus(src ? "loading" : "pending");
  }, [src]);
  const imageRef = (0, import_react76.useRef)();
  const load = (0, import_react76.useCallback)(() => {
    if (!src)
      return;
    flush();
    const img = new Image();
...
function AvatarImage(props) {
  ...
  if (showFallback) {
    ...
    ) : (0, import_react77.cloneElement)(icon, {
      role: "img",
...
var Avatar = forwardRef((props, ref) => {
  ...
  const [isLoaded, setIsLoaded] = (0, import_react78.useState)(false);
  const {
    src,
    srcSet,
    name,
...
function getValidChildren(children) {
  return import_react79.Children.toArray(children).filter(
    (child) => (0, import_react79.isValidElement)(child)
  );
}
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index2) => {
      ...
      return (0, import_react80.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index2) => (0, import_react82.cloneElement)(child, {
        separator,
        spacing,
...
function useButtonType(value) {
  const [isButton, setIsButton] = (0, import_react84.useState)(!value);
  const refCallback = (0, import_react84.useCallback)((node2) => {
    if (!node2)
      return;
...
function ButtonIcon(props) {
  ...
  const _children = (0, import_react85.isValidElement)(children) ? (0, import_react85.cloneElement)(children, {
    "aria-hidden": true,
    focusable: false
  }) : children;
...
function ButtonSpinner(props) {
  ...
  const spinnerStyles = (0, import_react86.useMemo)(
    () => ({
      display: "flex",
      alignItems: "center",
...
var Button = forwardRef((props, ref) => {
  ...
  const buttonStyles = (0, import_react87.useMemo)(() => {
...
function useCheckboxGroup(props = {}) {
  ...
  const handleChange = (0, import_react89.useCallback)(
    (eventOrValue) => {
      if (!value)
        return;
  ...
  const getCheckboxProps = (0, import_react89.useCallback)(
    (props2 = {}) => {
...
function useFormControlProvider(props) {
  ...
  const uuid = (0, import_react91.useId)();
  const id3 = idProp || `field-${uuid}`;
  const labelId = `${id3}-label`;
  const feedbackId = `${id3}-feedback`;
  const helpTextId = `${id3}-helptext`;
  const [hasFeedbackText, setHasFeedbackText] = (0, import_react91.useState)(false);
  const [hasHelpText, setHasHelpText] = (0, import_react91.useState)(false);
  const [isFocused, setFocus2] = (0, import_react91.useState)(false);
  const getHelpTextProps = (0, import_react91.useCallback)(
  ...
  const getLabelProps = (0, import_react91.useCallback)(
    (props2 = {}, forwardedRef = null) => {
      var _a, _b;
      return {
        ...props2,
  ...
  const getErrorMessageProps = (0, import_react91.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      id: feedbackId,
      ...props2,
      ref: mergeRefs(forwardedRef, (node2) => {
  ...
  const getRequiredIndicatorProps = (0, import_react91.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      role: "presentation",
...
function useCheckbox(props = {}) {
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react92.useState)(false);
  const [isFocused, setFocused] = (0, import_react92.useState)(false);
  const [isHovered, setHovered] = (0, import_react92.useState)(false);
  const [isActive, setActive] = (0, import_react92.useState)(false);
  (0, import_react92.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const inputRef = (0, import_react92.useRef)(null);
  const [rootIsLabelElement, setRootIsLabelElement] = (0, import_react92.useState)(true);
  const [checkedState, setCheckedState] = (0, import_react92.useState)(!!defaultChecked);
  const isControlled = checkedProp !== void 0;
  const isChecked = isControlled ? checkedProp : checkedState;
  const handleChange = (0, import_react92.useCallback)(
    (event) => {
  ...
  const onKeyUp = (0, import_react92.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getCheckboxProps = (0, import_react92.useCallback)(
    (props2 = {}, forwardedRef = null) => {
...
var Checkbox = forwardRef(function Checkbox2(props, ref) {
  ...
  const iconStyles = (0, import_react93.useMemo)(
    () => ({
  ...
  const clonedIcon = (0, import_react93.cloneElement)(icon, {
    __css: iconStyles,
...
function useCounter(props = {}) {
  ...
  const onChangeProp = useCallbackRef(onChange);
  const [valueState, setValue] = (0, import_react94.useState)(() => {
    var _a;
  ...
  const update = (0, import_react94.useCallback)(
    (next) => {
      if (next === value)
        return;
      if (!isControlled) {
  ...
  const clamp3 = (0, import_react94.useCallback)(
    (value2) => {
  ...
  const increment = (0, import_react94.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse2(step);
  ...
  const decrement = (0, import_react94.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse2(-step);
  ...
  const reset = (0, import_react94.useCallback)(() => {
    var _a;
    let next;
    if (defaultValue == null) {
      next = "";
  ...
  const castValue = (0, import_react94.useCallback)(
    (value2) => {
      var _a;
...
function useEditable(props = {}) {
  ...
  const [isEditing, setIsEditing] = (0, import_react96.useState)(defaultIsEditing);
  const [value, setValue] = useControllableState({
    defaultValue: defaultValue || "",
    value: valueProp,
    onChange: onChangeProp
  });
  const [prevValue, setPrevValue] = (0, import_react96.useState)(value);
  const inputRef = (0, import_react96.useRef)(null);
  const previewRef = (0, import_react96.useRef)(null);
  const editButtonRef = (0, import_react96.useRef)(null);
  const cancelButtonRef = (0, import_react96.useRef)(null);
  const submitButtonRef = (0, import_react96.useRef)(null);
  ...
  const onEdit = (0, import_react96.useCallback)(() => {
    if (isInteractive) {
      setIsEditing(true);
    }
  }, [isInteractive]);
  const onUpdatePrevValue = (0, import_react96.useCallback)(() => {
    setPrevValue(value);
  }, [value]);
  const onCancel = (0, import_react96.useCallback)(() => {
    setIsEditing(false);
    setValue(prevValue);
    onCancelProp == null ? void 0 : onCancelProp(prevValue);
  }, [onCancelProp, setValue, prevValue]);
  const onSubmit = (0, import_react96.useCallback)(() => {
    setIsEditing(false);
    setPrevValue(value);
  ...
  const onKeyDownWithoutSubmit = (0, import_react96.useCallback)(
    (event) => {
      const eventKey = event.key;
      const keyMap = {
        Escape: onCancel
  ...
  const onBlur3 = (0, import_react96.useCallback)(
    (event) => {
      var _a;
      if (!isEditing)
        return;
  ...
  const getPreviewProps = (0, import_react96.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getTextareaProps = (0, import_react96.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      hidden: !isEditing,
      placeholder,
  ...
  const getEditButtonProps = (0, import_react96.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Edit",
      ...props2,
      type: "button",
  ...
  const getSubmitButtonProps = (0, import_react96.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      "aria-label": "Submit",
  ...
  const getCancelButtonProps = (0, import_react96.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Cancel",
      id: "cancel",
      ...props2,
...
function useClipboard(initialValue, optionsOrTimeout = {}) {
  ...
  const [value, setValue] = (0, import_react120.useState)(initialValue);
  ...
  function InputGroup2(props, ref) {
    ...
    return (0, import_jsx_runtime61.jsx)(
      chakra.div,
      {
        ...
        ...rest,
        children: (0, import_jsx_runtime61.jsx)(InputGroupStylesProvider, { value: styles, children: clones })
      }
    );
  }
);
...
var InputElement = forwardRef(function InputElement2(props, ref) {
  ...
  return (0, import_jsx_runtime63.jsx)(StyledInputElement, { ref, __css: elementStyles, ...rest });
});
...
var List = forwardRef(function List2(props, ref) {
  ...
  return (0, import_jsx_runtime65.jsx)(ListStylesProvider, { value: styles, children: (0, import_jsx_runtime65.jsx)(
    chakra.ul,
    {
      ref,
...
var OrderedList = forwardRef((props, ref) => {
  const { as, ...rest } = props;
  return (0, import_jsx_runtime65.jsx)(List, { ref, as: "ol", styleType: "decimal", marginStart: "1em", ...rest });
});
OrderedList.displayName = "OrderedList";
var UnorderedList = forwardRef(function UnorderedList2(props, ref) {
  const { as, ...rest } = props;
  return (0, import_jsx_runtime65.jsx)(List, { ref, as: "ul", styleType: "initial", marginStart: "1em", ...rest });
});
UnorderedList.displayName = "UnorderedList";
var ListItem = forwardRef(function ListItem2(props, ref) {
  const styles = useListStyles();
  return (0, import_jsx_runtime65.jsx)(chakra.li, { ref, ...props, __css: styles.item });
});
ListItem.displayName = "ListItem";
var ListIcon = forwardRef(function ListIcon2(props, ref) {
  const styles = useListStyles();
  return (0, import_jsx_runtime65.jsx)(Icon, { ref, role: "presentation", ...props, __css: styles.icon });
});
...
var Grid = forwardRef(function Grid2(props, ref) {
  ...
  return (0, import_jsx_runtime66.jsx)(chakra.div, { ref, __css: styles, ...rest });
});
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const styles = (0, import_react124.useMemo)(() => {
  ...
  const childrenToRender = (0, import_react124.useMemo)(
    () => shouldWrapChildren ? import_react124.Children.map(children, (child, index2) => (0, import_jsx_runtime69.jsx)(WrapItem, { children: child }, index2)) : children,
  ...
  return (0, import_jsx_runtime69.jsx)(
    chakra.div,
    {
      ...
      overflow: "hidden",
      ...rest,
      children: (0, import_jsx_runtime69.jsx)(chakra.ul, { className: "chakra-wrap__list", __css: styles, children: childrenToRender })
    }
  );
});
...
var StackItem = (props) => (0, import_jsx_runtime70.jsx)(
  chakra.div,
  {
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react125.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index2) => {
      ...
      const wrappedChild = (0, import_jsx_runtime71.jsx)(StackItem, { children: child }, key);
      ...
      return (0, import_jsx_runtime71.jsxs)(import_react125.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
var VStack = forwardRef((props, ref) => (0, import_jsx_runtime72.jsx)(Stack, { align: "center", ...props, direction: "column", ref }));
VStack.displayName = "VStack";

// node_modules/@chakra-ui/layout/dist/chunk-HUQHYERK.mjs
var import_jsx_runtime73 = __toESM(require_jsx_runtime(), 1);
var HStack = forwardRef((props, ref) => (0, import_jsx_runtime73.jsx)(Stack, { align: "center", ...props, direction: "row", ref }));
...
var Circle = forwardRef(function Circle2(props, ref) {
  ...
  return (0, import_jsx_runtime77.jsx)(Square, { size, ref, borderRadius: "9999px", ...rest });
});
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime78.jsx)(import_jsx_runtime78.Fragment, { children: chunks.map((chunk, index2) => {
    return chunk.match ? (0, import_jsx_runtime78.jsx)(Mark, { sx: styles, children: chunk.text }, index2) : (0, import_jsx_runtime78.jsx)(import_react126.Fragment, { children: chunk.text }, index2);
  }) });
}
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react128.useState)(() => {
    return queries.map((query2, index2) => ({
      media: query2,
      matches: ssr ? !!fallbackValues[index2] : env2.window.matchMedia(query2).matches
    }));
  });
...
function Hide(props) {
  ...
  return (0, import_jsx_runtime89.jsx)(Visibility, { breakpoint: query, hide: true, ssr, children });
}
...
function Show(props) {
  const { children, ssr } = props;
  const query = useQuery(props);
  return (0, import_jsx_runtime90.jsx)(Visibility, { breakpoint: query, ssr, children });
}
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime91.jsx)(MenuDescendantsProvider, { value: descendants, children: (0, import_jsx_runtime91.jsx)(MenuProvider, { value: context, children: (0, import_jsx_runtime91.jsx)(MenuStylesProvider, { value: styles, children: runIfFn(children, { isOpen, onClose, forceUpdate }) }) }) });
};
...
var MenuItem = forwardRef((props, ref) => {
  ...
  const _children = shouldWrap ? (0, import_jsx_runtime95.jsx)("span", { style: { pointerEvents: "none", flex: 1 }, children }) : children;
  return (0, import_jsx_runtime95.jsxs)(
    StyledMenuItem,
    {
      ...
      children: [
        icon && (0, import_jsx_runtime95.jsx)(MenuIcon, { fontSize: "0.8em", marginEnd: iconSpacing, children: icon }),
        _children,
        command && (0, import_jsx_runtime95.jsx)(MenuCommand, { marginStart: commandSpacing, children: command })
      ]
    }
  );
});
...
var MenuGroup = forwardRef((props, ref) => {
  ...
  const styles = useMenuStyles();
  return (0, import_jsx_runtime97.jsxs)("div", { ref, className: "chakra-menu__group", role: "group", children: [
    title && (0, import_jsx_runtime97.jsx)(chakra.p, { className: _className, ...rest, __css: styles.groupTitle, children: title }),
    children
  ] });
});
...
var CheckIcon3 = (props) => (0, import_jsx_runtime101.jsx)("svg", { viewBox: "0 0 14 14", width: "1em", height: "1em", ...props, children: (0, import_jsx_runtime101.jsx)(
  "polygon",
  {
    fill: "currentColor",
  ...
  (props, ref) => {
    ...
    return (0, import_jsx_runtime101.jsxs)(
      StyledMenuItem,
      {
        ...
        children: [
          icon !== null && (0, import_jsx_runtime101.jsx)(
            MenuIcon,
            {
              fontSize: "0.8em",
              marginEnd: iconSpacing,
              opacity: props.isChecked ? 1 : 0,
              children: icon || (0, import_jsx_runtime101.jsx)(CheckIcon3, {})
            }
          ),
          (0, import_jsx_runtime101.jsx)("span", { style: { flex: 1 }, children: optionProps.children })
        ]
      }
    );
  }
...
var Modal = (props) => {
  ...
  return (0, import_jsx_runtime103.jsx)(ModalContextProvider, { value: context, children: (0, import_jsx_runtime103.jsx)(ModalStylesProvider, { value: styles, children: (0, import_jsx_runtime103.jsx)(AnimatePresence, { onExitComplete: onCloseComplete, children: context.isOpen && (0, import_jsx_runtime103.jsx)(Portal, { ...portalProps, children }) }) }) });
};
...
function useCallbackRef3(initialValue, callback) {
  var ref = (0, import_react144.useState)(function() {
    return {
      // value
      value: initialValue,
      // last callback
  ...
  return function wrap4(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react148.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
    }(import_react148.PureComponent);
...
var focusInside = function(topNode, activeElement) {
  ...
  return getAllAffectedNodes(topNode).some(function(node2) {
    return contains5(node2, activeElement) || focusInsideIframe(node2, activeElement);
  });
};
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react149.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react149.useCallback)(() => {
    var _a;
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react155.useState)(false);
  const [action, setAction] = (0, import_react155.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react155.useState)(true);
  const timeoutRef = (0, import_react155.useRef)(null);
  ...
  const up = (0, import_react155.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react155.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop2 = (0, import_react155.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const inputSelectionRef = (0, import_react156.useRef)(null);
  const incrementButtonRef = (0, import_react156.useRef)(null);
  const decrementButtonRef = (0, import_react156.useRef)(null);
  const sanitize2 = (0, import_react156.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse4 = (0, import_react156.useCallback)(
    (value) => {
      var _a;
  ...
  const format2 = (0, import_react156.useCallback)(
    (value) => {
      var _a;
  ...
  const increment = (0, import_react156.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react156.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const _onFocus = (0, import_react156.useCallback)(
    (event) => {
      var _a, _b, _c;
  ...
  const ariaValueText = (0, import_react156.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react156.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react156.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  ...
  const spinUp = (0, import_react156.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react156.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react156.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react156.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react157.useMemo)(() => context, [context]);
...
var NumberDecrementStepper = forwardRef(function NumberDecrementStepper2(props, ref) {
  ...
  return (0, import_jsx_runtime116.jsx)(StyledStepper, { ...decrement, __css: styles.stepper, children: (_a = props.children) != null ? _a : (0, import_jsx_runtime116.jsx)(TriangleDownIcon, {}) });
});
...
var NumberIncrementStepper = forwardRef(function NumberIncrementStepper2(props, ref) {
  ...
  const styles = useNumberInputStyles();
  return (0, import_jsx_runtime116.jsx)(StyledStepper, { ...increment, __css: styles.stepper, children: (_a = props.children) != null ? _a : (0, import_jsx_runtime116.jsx)(TriangleUpIcon, {}) });
});
...
function usePinInput(props = {}) {
  ...
  const [moveFocus, setMoveFocus] = (0, import_react158.useState)(true);
  ...
  const focusNext = (0, import_react158.useCallback)(
    (index2) => {
  ...
  const setValue = (0, import_react158.useCallback)(
  ...
  const clear = (0, import_react158.useCallback)(() => {
    var _a;
  ...
  const getNextValue = (0, import_react158.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react159.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react160.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react161.useRef)(null);
  const triggerRef = (0, import_react161.useRef)(null);
  const popoverRef = (0, import_react161.useRef)(null);
  const isHoveringRef = (0, import_react161.useRef)(false);
  const hasBeenOpened = (0, import_react161.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react161.useState)(false);
  const [hasBody, setHasBody] = (0, import_react161.useState)(false);
  ...
  const getPopoverProps = (0, import_react161.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react161.useCallback)(
  ...
  const getAnchorProps = (0, import_react161.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react161.useRef)();
  const closeTimeout = (0, import_react161.useRef)();
  const maybeReferenceRef = (0, import_react161.useCallback)(
    (node2) => {
  ...
  const getTriggerProps = (0, import_react161.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react161.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react161.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  const child = import_react162.Children.only(props.children);
  const { getAnchorProps } = usePopoverContext();
  return (0, import_react162.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
var CircularProgress = forwardRef(
  (props, ref) => {
    ...
    const determinant = isIndeterminate ? void 0 : ((_a = progress4.percent) != null ? _a : 0) * 2.64;
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react163.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react163.useRef)(null);
  const focus2 = (0, import_react163.useCallback)(() => {
  ...
  const uuid = (0, import_react163.useId)();
  const fallbackName = `radio-${uuid}`;
  const name = nameProp || fallbackName;
  const onChange = (0, import_react163.useCallback)(
    (eventOrValue) => {
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react165.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react165.useState)(false);
  const [isFocused, setFocused] = (0, import_react165.useState)(false);
  const [isHovered, setHovering] = (0, import_react165.useState)(false);
  const [isActive, setActive] = (0, import_react165.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react165.useState)(Boolean(defaultChecked));
  ...
  const onKeyUp = (0, import_react165.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getRadioProps = (0, import_react165.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react166.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime134.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react166.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react167.useRef)(true);
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react170.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react171.useLayoutEffect : import_react171.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react171.useState)([]);
...
function useRangeSlider(props) {
  ...
  const focusThumb = (0, import_react172.useCallback)(
    (index2) => {
      ...
      if (idx !== -1 && focusThumbOnChange) {
        ...
        const thumb = (_a = rootRef.current) == null ? void 0 : _a.ownerDocument.getElementById(id3);
        if (thumb) {
  ...
  const getOutputProps = (0, import_react172.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react173.useMemo)(
...
function useSlider(props) {
  ...
  const rootRef = (0, import_react174.useRef)(null);
  const reactId = (0, import_react174.useId)();
  const uuid = idProp != null ? idProp : reactId;
  ...
  const actions = (0, import_react174.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react174.useMemo)(() => {
    const state2 = stateRef.current;
  ...
  const getInnerTrackProps = (0, import_react174.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react174.useCallback)(
    (props2, ref = null) => {
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index2) => (0, import_react176.createElement)(
      TabPanelProvider,
      {
        key: index2,
        value: {
