...
} from "./chunk-CPLVMEQL.js";
import "./chunk-CLXCYS5V.js";
import {
  __commonJS,
  __toCommonJS
      ...
      var internalSubscriptionsSlice = (0, import_toolkit6.createSlice)({
        ...
        reducers: {
          subscriptionsUpdated: function(state, action) {
            return (0, import_immer2.applyPatches)(state, action.payload);
          }
        }
      });
        ...
        if (didMutate) {
          if (!dispatchQueued) {
            queueMicrotaskShim(function() {
              ...
              var _j3 = (0, import_immer3.produceWithPatches)(previousSubscriptions, function() {
